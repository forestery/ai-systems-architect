...
到 2024 年底，讨论开始变了。提示词仍然重要，但所有人都意识到它已经摸到了天花板。你可以在 Prompt 里写一万字的指令，但如果 Agent 拿到的项目上下文是错的，指令再精准也没用。
...
> **本章只有一个观点：** Context Engineering 是 Agent 时代第一个真正的「承重技能」。提示词决定 Agent 怎么想，上下文决定 Agent 知道什么——如果你给它的信息是错的，提示词再精准也没用。
